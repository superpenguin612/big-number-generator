 ...
 * @author racov
 */
public final class JustANumberCreator {
    BigDecimal number;
    String[] numberSplit;
    ...
    public JustANumberCreator(String input) {
        this.number = new BigDecimal(input);
    }
    
    void calculate() {
        this.numberSplit = numberSplitter(this.number);
        BigDecimal arraySize = new BigDecimal(numberSplit.length);
        
        hundredsNames = new String[numberSplit.length];
        illionsNames = new String[numberSplit.length];
        results = new String[numberSplit.length];
        
        for(int i = 0; i < numberSplit.length; i++) {
            this.hundredsNames[i] = hundredsMaker(this.numberSplit[i]);
            this.illionsNames[i] = illionsMaker(arraySize, new BigDecimal(i));
            this.results[i] = this.hundredsNames[i] + " " + this.illionsNames[i];
        }
    }
    
    String hundredsMaker(String threeDigitSet) {
        ...
        String[] tenToNinety = {"", "ten", "twenty", "thirty", "fourty", "fifty", "sixty", "seventy", "eighty", "ninety"};
        ...
        String hundredsName = "";
        if (separatedHundredsDigits[0] != 0 && separatedHundredsDigits[1] == 1 && separatedHundredsDigits[2] != 0) {        //911 (S)
            hundredsName = part1 + " " + part2;
        } else if (separatedHundredsDigits[0] == 0 && separatedHundredsDigits[1] == 1 && separatedHundredsDigits[2] != 0) { //011 (S)
            hundredsName = part2;
        } else if (separatedHundredsDigits[0] == 0 && separatedHundredsDigits[1] == 0 && separatedHundredsDigits[2] != 0) { //009
            hundredsName = part3;
        } else if (separatedHundredsDigits[0] == 0 && separatedHundredsDigits[1] != 0 && separatedHundredsDigits[2] == 0) { //090
            hundredsName = part2;
        } else if (separatedHundredsDigits[0] == 0 && separatedHundredsDigits[1] != 0 && separatedHundredsDigits[2] != 0) { //099
            hundredsName = part2 + " " + part3;
        } else if (separatedHundredsDigits[0] != 0 && separatedHundredsDigits[1] == 0 && separatedHundredsDigits[2] == 0) { //900
            hundredsName = part1;
        } else if (separatedHundredsDigits[0] != 0 && separatedHundredsDigits[1] == 0 && separatedHundredsDigits[2] != 0) { //909
            hundredsName = part1 + " " + part3;
        } else if (separatedHundredsDigits[0] != 0 && separatedHundredsDigits[1] != 0 && separatedHundredsDigits[2] == 0) { //990
            hundredsName = part1 + " " + part2;
        } else {                                                                                                            //999
    ...
    String illionsMaker(BigDecimal arraySize, BigDecimal slotNum) {
        String name = "";
    ...
    String[] numberSplitter(BigDecimal number) {
        String numberString = number.toPlainString();
            ...
            for(int i = 0; i < (floor(numberString.length() / 3)); i++) {
                switch (numberString.length() % 3) {
                    ...
                    default:
                        separatedSets[i] =
                            Character.toString(numberString.charAt(i*3 + 0)) +
                            Character.toString(numberString.charAt(i*3 + 1)) +
                            Character.toString(numberString.charAt(i*3 + 2));
                        break;
                }
            ...
            switch(numberString.length() % 3) {
                case 1:
                    separatedSets[0] =
                    "00" + Character.toString(numberString.charAt(0));
                    break;
                case 2:
                    separatedSets[0] =
                    "0" + Character.toString(numberString.charAt(0)) +
                    Character.toString(numberString.charAt(1));
                    break;
            }
